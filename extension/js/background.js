...
// Leaving randomiser out for a bit. Going to concentrate on manually selecting a picture for now.

    $('body').css('background','url('+bg+')');

var fa = document.createElement('fa')
    fa.innerHTML = "<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css'>";
    document.head.appendChild(fa);

var uploader = document.createElement('uploader')
    uploader.innerHTML = "<i class='fa fa-picture-o'></i>";
